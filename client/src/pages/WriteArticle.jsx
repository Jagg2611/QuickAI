...
const WriteArticle = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      setLoading(true);
      const prompt = `Write an aritcle about ${input} in ${selectedLength.text}`;
  ...
  return (
    ...
    >
      ...
      >
        ...
        bg-gradient-to-r from-[#226BFF] to-[#65ADFF] text-white px-4
  ...
  border-gray-200 min-h-96 max-h-[600px]"
      >
        ...
        {!content ? (
          ...
          <div className="mt-3 h-full overflow-y-auto text-slate-600">
